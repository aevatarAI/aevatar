---
name: arch-audit
description: Use when auditing architecture compliance against AGENTS.md, checking for drift before milestones, validating architecture drift after large merges, or running periodic architecture checks. Triggers on "架构审计", "architecture audit", "architecture drift".
---
...
- When CEO/architect suspects drift from AGENTS.md
...
Any match = **VIOLATION** (query-time replay/priming forbidden by AGENTS.md).
