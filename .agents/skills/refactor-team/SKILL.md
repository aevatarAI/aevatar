...
Read `.Codex/skills/refactor-team/auditor-prompt.md`, then spawn auditor.
...
Read `.Codex/skills/refactor-team/implementer-prompt.md`. Determine branch type:
...
Read prompt files:
- `.Codex/skills/refactor-team/arch-reviewer-prompt.md`
- `.Codex/skills/refactor-team/quality-reviewer-prompt.md`
- `.Codex/skills/refactor-team/ci-guard-runner-prompt.md`
...
## Referenced AGENTS.md Rules

<quoted rules>

🤖 Generated with [Codex](https://Codex.com/Codex) Refactoring Team
PREOF
)"
```
