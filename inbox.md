# Team runtime semantics foundation
...
Scope: implement requests 5 and prerequisite pieces for request 1.
...
Current evidence:
- apps/aevatar-console-web/src/pages/teams/home.tsx duplicates compareRuns, isSuccessfulRun, isWaitingRun, isFailedRun around lines 216-279.
- apps/aevatar-console-web/src/pages/teams/runtime/teamRuntimeLens.ts duplicates sortRuns, isSuccessfulRun, isBlockedRun, isFailedRun around lines 189-239.
- workflowOperationalUnits.ts also has run-state semantics.

Required work:
- Add a small shared module such as apps/aevatar-console-web/src/pages/teams/runtime/teamStatusSemantics.ts or runtimeRunSemantics.ts.
...
- Update home.tsx, workflowOperationalUnits.ts, and runtime/teamRuntimeLens.ts to use the shared helpers without changing visible behavior intentionally.
