...
public sealed record ChannelBotRegistrationScopeBackfillSelection(
    string? RegistrationId = null,
    string? NyxAgentApiKeyId = null,
    bool Force = false);

public sealed record ChannelBotRegistrationScopeBackfillAuthorization(
...
/// </summary>
public enum ChannelBotRegistrationScopeBackfillStatus
{
    NotRequired,
    Skipped,
    Rejected,
...
public static class ChannelBotRegistrationScopeBackfillStatusExtensions
{
...
public sealed record ChannelBotRegistrationScopeBackfillResult(
