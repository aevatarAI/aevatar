...
internal sealed class ChannelNativeSkillRunnerOutboundDeliveryPort : ISkillRunnerOutboundDeliveryPort
{
        ...
        SkillRunnerOutboundConfig? outbound)
    {
        ...
        return new UserAgentDeliveryTarget(
            ...
            LarkReceiveId: outbound.LarkReceiveId ?? string.Empty,
            LarkReceiveIdType: outbound.LarkReceiveIdType ?? string.Empty,
            LarkReceiveIdFallback: outbound.LarkReceiveIdFallback ?? string.Empty,
            LarkReceiveIdTypeFallback: outbound.LarkReceiveIdTypeFallback ?? string.Empty,
