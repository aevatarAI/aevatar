...
public static class NyxIdChatControlCommands
{
    ...
    public const string TurnIdempotencyConflict =
        "NYXID_CHAT_TURN_IDEMPOTENCY_CONFLICT";
    public const string TurnIdempotencyConflictMessage =
        "The turn identity was already admitted with different request semantics.";
        ...
        Timestamp now)
    {
        ...
        NyxIdChatTurnReplayRetention.RetainTerminalTurn(next, next.ActiveTurn);
