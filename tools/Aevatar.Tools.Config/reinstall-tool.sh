...
TOOL_PACKAGE_ID="aevatar-config"
CONFIGURATION="${1:-Release}"

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="$(cd "${SCRIPT_DIR}/../.." && pwd)"
PROJECT_PATH="${REPO_ROOT}/tools/Aevatar.Tools.Config/Aevatar.Tools.Config.csproj"
PACKAGE_SOURCE_DIR="${REPO_ROOT}/tools/Aevatar.Tools.Config/bin/${CONFIGURATION}"
