...
- `tools/ci/agent_profile_governance_guard.sh`: keeps reviewed agent profiles immutable, exact-versioned, Host-owned, default-off, and isolated from relay/runtime name branches.
