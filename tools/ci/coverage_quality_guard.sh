...
# generated provider shells, host app shells, and boundary SDK/UI adapters are
# validated by dedicated integration or consumer tests and would otherwise drown
# the core branch signal.
assembly_filters="${COVERAGE_ASSEMBLY_FILTERS:-+Aevatar.*;-*.Tests;-AutoGeneratedProgram;-Aevatar.Demos.*;-Aevatar.Tools.*;-Aevatar.Bootstrap;-Aevatar.*.Providers.*;-Aevatar.AI.LLMProviders.*;-Aevatar.AI.ToolProviders.*;-Aevatar.Authentication.*;-Aevatar.GAgents.*;-Aevatar.Hosting;-Aevatar.GAgentService.Hosting;-Aevatar.Mainnet.Host.Api;-Aevatar.Studio.*;-Aevatar.Foundation.Runtime.Implementations.Garnet;-Aevatar.Foundation.Runtime.Implementations.Orleans.Transport.KafkaProvider;-Aevatar.Workflow.Sdk;-Aevatar.Workflow.Extensions.Bridge;-Aevatar.Workflow.Presentation.AGUIAdapter}"
