...
assembly_filters="${COVERAGE_ASSEMBLY_FILTERS:-+Aevatar.*;-*.Tests;-AutoGeneratedProgram;-Aevatar.Demos.*;-Aevatar.Tools.*;-Aevatar.Bootstrap;-Aevatar.*.Providers.*;-Aevatar.AI.LLMProviders.*;-Aevatar.AI.ToolProviders.*;-Aevatar.Foundation.Runtime.Persistence.Implementations.Garnet;-Aevatar.Workflow.Sdk;-Aevatar.Workflow.Extensions.Bridge;-Aevatar.Workflow.Presentation.AGUIAdapter}"
