...
assembly_filters="${COVERAGE_ASSEMBLY_FILTERS:-+Aevatar.*;-*.Tests;-AutoGeneratedProgram;-Aevatar.Demos.*;-Aevatar.Tools.*;-Aevatar.Bootstrap;-Aevatar.*.Providers.*;-Aevatar.AI.LLMProviders.*;-Aevatar.AI.ToolProviders.*;-Aevatar.GAgents.*;-Aevatar.Hosting;-Aevatar.Mainnet.Host.Api;-Aevatar.Studio.Hosting;-Aevatar.Studio.Infrastructure;-Aevatar.Studio.Application;-Aevatar.Foundation.Runtime.Implementations.Garnet;-Aevatar.Foundation.Runtime.Implementations.Orleans.Transport.KafkaProvider;-Aevatar.Workflow.Sdk;-Aevatar.Workflow.Extensions.Bridge;-Aevatar.Workflow.Presentation.AGUIAdapter}"
