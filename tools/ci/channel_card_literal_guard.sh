...
# inside agents/Aevatar.GAgents.ChannelRuntime or agents/Aevatar.GAgents.NyxidChat are a
# regression signal that someone sidestepped the composer.
#
# Scan:
#   - agents/Aevatar.GAgents.ChannelRuntime/**/*.cs
...
allowlist=(
  "agents/Aevatar.GAgents.ChannelRuntime/AgentBuilderCardFlow.cs"
)
...
scan_project "agents/Aevatar.GAgents.ChannelRuntime"
