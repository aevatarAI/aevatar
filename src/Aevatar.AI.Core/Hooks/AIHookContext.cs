// ─────────────────────────────────────────────────────────────
// AIHookContext — AI 层 Hook 上下文
// 继承 GAgentHookContext，增加 LLM / Tool 字段
// ─────────────────────────────────────────────────────────────
...
/// <summary>
/// AI 层 Hook 上下文。继承 Foundation 的 GAgentHookContext，
/// 增加 LLM Request/Response、Tool Name/Args/Result 等字段。
/// </summary>
public sealed class AIHookContext : GAgentHookContext
{
    // ─── LLM 上下文 ───
