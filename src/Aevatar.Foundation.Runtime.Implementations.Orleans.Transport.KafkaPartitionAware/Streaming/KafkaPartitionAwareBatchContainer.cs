...
[GenerateSerializer]
internal sealed class KafkaPartitionAwareBatchContainer : IBatchContainer
{
    [Id(0)]
    ...
    private KafkaPartitionAwareBatchContainer()
    {
    }

    public KafkaPartitionAwareBatchContainer(
        StreamId streamId,
