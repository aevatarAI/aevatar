...
public sealed class OrnnPublishSkillTool : IAgentTool
{
    ...
    public string Description =>
        ...
        "Workflow YAMLs published here are written to workflows/{workflowId}.yaml as Ornn package templates/import sources, not Scope Workflow runtime publication. " +
