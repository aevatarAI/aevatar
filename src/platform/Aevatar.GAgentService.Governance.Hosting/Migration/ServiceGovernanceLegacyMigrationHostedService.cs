...
/// Iterates all known services and consolidates legacy governance actor streams
/// into the unified ServiceConfiguration model.
/// <para>
...
public sealed class ServiceGovernanceLegacyMigrationHostedService : IHostedService
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        foreach (var service in services)
        {
            ...
            var imported = await ImportIfNeededAsync(identity, cancellationToken);
            if (imported)
    ...
    private async Task<bool> ImportIfNeededAsync(ServiceIdentity identity, CancellationToken ct)
    {
