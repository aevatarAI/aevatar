...
namespace Aevatar.GAgentService.Governance.Application.Internal;
...
internal static class ServiceCommandEnvelopeFactory
{
    public static EventEnvelope Create(string targetActorId, IMessage payload, string correlationId)
    {
        ...
        return new EventEnvelope
        {
            ...
            Route = EnvelopeRouteSemantics.CreateDirect("gagent-service.governance.application", targetActorId),
