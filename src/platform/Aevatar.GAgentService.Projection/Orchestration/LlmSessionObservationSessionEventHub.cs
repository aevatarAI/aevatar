...
public sealed class LlmSessionObservationSessionEventHub : IProjectionSessionEventHub<EventEnvelope>
{
    private readonly ProjectionSessionEventHub<EventEnvelope> _inner;

    public LlmSessionObservationSessionEventHub(
        IStreamProvider streamProvider,
        LlmSessionObservationSessionEventCodec codec,
