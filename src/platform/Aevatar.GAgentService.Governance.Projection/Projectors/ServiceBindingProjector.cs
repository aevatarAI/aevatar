...
{
    private readonly IProjectionWriteDispatcher<ServiceBindingCatalogReadModel> _storeDispatcher;
    ...
    public ServiceBindingProjector(
        IProjectionWriteDispatcher<ServiceBindingCatalogReadModel> storeDispatcher,
