        ...
        for (var round = 0; round < MaxToolRounds; round++)
        {
            var roundRequest = new LLMRequest
            {
                ...
                CallerContext = new LLMRequestCallerContext(
                    ...
                    new LLMRequestCallerCredentials(toolContext.Credentials.CredentialRef)),
                Tools = tools,
                ToolContext = toolContext,
                LlmControl = new LLMControlContext(
                    CredentialRef: toolContext.Credentials.CredentialRef,
                    OrganizationCredentialRef: toolContext.Credentials.OrganizationCredentialRef,
                    SenderCredentialRef: toolContext.Credentials.SenderCredentialRef,
