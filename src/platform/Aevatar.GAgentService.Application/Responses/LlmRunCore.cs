        ...
        for (var round = 0; round < MaxToolRounds; round++)
        {
            var roundRequest = new LLMRequest
            {
                ...
                CallerContext = new LLMRequestCallerContext(
                    ...
                    new LLMRequestCallerCredentials(toolContext.Credentials.AccessToken)),
                Tools = tools,
                ToolContext = toolContext,
                LlmControl = new LLMControlContext(
                    NyxIdAccessToken: toolContext.Credentials.AccessToken,
                    NyxIdOrgToken: toolContext.Credentials.OrganizationToken,
                    SenderNyxIdAccessToken: toolContext.Credentials.SenderAccessToken,
