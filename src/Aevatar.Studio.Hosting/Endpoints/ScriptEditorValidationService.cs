...
internal sealed class ScriptEditorValidationService
{
    ...
    public ScriptEditorValidationResult Validate(
        ...
        string? source = null)
    {
        var normalizedScriptId = StudioEndpoints.NormalizeStudioDocumentId(scriptId, "script");
        var normalizedRevision = StudioEndpoints.NormalizeStudioDocumentId(revision, "draft");
