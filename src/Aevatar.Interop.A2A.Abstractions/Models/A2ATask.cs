...
/// <summary>A2A Task — represents a task for a cross-agent interaction.</summary>
...
/// <summary>A2A Message — a single conversation message.</summary>
...
/// <summary>A2A Artifact — an output artifact generated by an agent.</summary>
...
/// <summary>A2A Part — a content fragment in a message/artifact. Distinguished by the "type" field in the A2A protocol.</summary>
...
/// <summary>Custom JSON converter for A2A Part that routes to the concrete subtype based on the "type" field.</summary>
