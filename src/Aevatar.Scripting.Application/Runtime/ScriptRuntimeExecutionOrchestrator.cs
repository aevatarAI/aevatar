...
public sealed class ScriptRuntimeExecutionOrchestrator : IScriptRuntimeExecutionOrchestrator
{
    ...
    private readonly IScriptRuntimeCapabilityComposer _capabilityComposer;

    public ScriptRuntimeExecutionOrchestrator(
        IScriptPackageCompiler compiler,
        IScriptRuntimeCapabilityComposer capabilityComposer)
    {
        _compiler = compiler ?? throw new ArgumentNullException(nameof(compiler));
        _capabilityComposer = capabilityComposer ?? throw new ArgumentNullException(nameof(capabilityComposer));
    }
