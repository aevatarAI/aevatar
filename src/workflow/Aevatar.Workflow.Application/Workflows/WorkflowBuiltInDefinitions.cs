...
public static class WorkflowBuiltInDefinitions
{
    ...
    public static string AutoYaml { get; } = BuildAutoWorkflowYaml(
        workflowName: "auto",
    ...
    public static string AutoReviewYaml { get; } = BuildAutoWorkflowYaml(
