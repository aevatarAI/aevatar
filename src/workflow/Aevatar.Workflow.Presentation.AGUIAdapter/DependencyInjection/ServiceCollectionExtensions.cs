...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddWorkflowExecutionAGUIAdapter(this IServiceCollection services)
    {
        ...
        services.TryAddEnumerable(ServiceDescriptor.Singleton<IWorkflowRunEventEnvelopeMappingHandler, WorkflowInteractiveActionRunEventEnvelopeMappingHandler>());
        ...
        services.TryAddEnumerable(ServiceDescriptor.Singleton<IWorkflowRunEventEnvelopeMappingHandler, RoleChatSessionProgressRunEventEnvelopeMappingHandler>());
