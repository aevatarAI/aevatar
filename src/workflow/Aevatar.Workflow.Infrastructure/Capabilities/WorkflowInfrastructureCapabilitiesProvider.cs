        ...
        new Dictionary<string, PrimitiveMetadataDescriptor>(StringComparer.OrdinalIgnoreCase)
        {
            ["transform"] = new(
                ...
                [
                    ...
                    new PrimitiveParameterDescriptor("aggregate", "string", false, "Required group_by aggregate.", EnumValuesInput: ["sum", "count", "avg"]),
                    new PrimitiveParameterDescriptor("precision", "int", false, "Decimal places for numeric precision; aliases: scale, digits, places."),
