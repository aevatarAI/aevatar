...
/// </summary>
public sealed class SecureInputModule : IEventModule
{
    ...
    public async Task HandleAsync(EventEnvelope envelope, IEventHandlerContext ctx, CancellationToken ct)
    {
        ...
        stepCompleted.Metadata["secure.input"] = "true";
        stepCompleted.Metadata["secure.variable"] = variableName;
        stepCompleted.Metadata["secure.redacted_output"] = maskedOutput;
