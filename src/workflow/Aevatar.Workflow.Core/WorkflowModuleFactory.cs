...
public class WorkflowModuleFactory : IEventModuleFactory<IWorkflowExecutionContext>
{
    ...
    public virtual bool TryCreate(string name, out IEventModule<IWorkflowExecutionContext>? module)
    {
        module = null;
