...
- `WorkflowRunInsightReportDocument.ProjectionScope = RunIsolated`
...
flowchart LR
  ...
  REPORTP["WorkflowRunInsightReportDocumentProjector"]
  ...
  REPORT["WorkflowRunInsightReportDocument"]
...
- graph 直接读取 graph store，不再从 `WorkflowRunInsightReportDocument` 派生
