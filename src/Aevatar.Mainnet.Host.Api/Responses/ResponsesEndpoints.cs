...
internal static partial class ResponsesApiEndpoints
{
        ...
        CancellationToken ct)
    {
        ...
        var facade = ActivatorUtilities.CreateInstance<ResponsesCommandFacade>(http.RequestServices);
        ...
        CancellationToken ct)
    {
        ...
        var facade = ActivatorUtilities.CreateInstance<ResponsesCommandFacade>(http.RequestServices);
        return await facade.CancelAsync(responseId, bearerToken, http, ct);
    }
