...
public sealed class MainnetAgentProfileRolloutSelector : INyxIdChatAgentProfileSnapshotSource
{
    ...
    private static void ValidateProfile(AgentProfileSnapshot profile)
    {
        ...
        RequireNonEmpty(profile.AgentKind, "agentKind");
        ...
        string fieldName)
    {
        ...
        var toolNames = ValidateUniqueNames(policy.ToolNames, $"{fieldName}.toolNames");
        var toolSetRefs = ValidateUniqueNames(policy.ToolSetRefs, $"{fieldName}.toolSetRefs");
    ...
    private static HashSet<string> ValidateUniqueNames(IEnumerable<string> values, string fieldName)
    {
