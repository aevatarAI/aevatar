...
/// </summary>
// Refactor (issue-377): Old pattern: session event entries used ScopeId for root actor routing.
// Refactor (issue-377): Old pattern: projectors could preserve the alias into the hub call.
// Refactor (issue-377): New principle: projector entries expose RootActorId explicitly.
// Refactor (issue-377): New principle: hub fanout receives RootActorId + SessionId.
...
// Refactor (issue-377): Old pattern: ProjectionSessionEventEntry.ScopeId meant root actor id.
// Refactor (issue-377): Old pattern: the entry model carried a misleading first dimension.
// Refactor (issue-377): New principle: RootActorId is the first routing invariant.
// Refactor (issue-377): New principle: SessionId remains the second dimension for fanout.
