...
- `Projection/WorkflowExecutionAGUIEventProjector.cs`
  - 同一投影链路下的 AGUI 输出 projector
- `Projection/WorkflowExecutionRunOrchestrator.cs`
...
即：API 只负责协议，CQRS 运行时由 WorkflowExecution 模块和 Orchestrator 处理。
