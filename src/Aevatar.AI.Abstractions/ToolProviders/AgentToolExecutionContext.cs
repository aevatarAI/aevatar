...
public sealed record AgentToolSenderBindingContext(string? BindingId, string? NyxUserId = null)
{
    public static AgentToolSenderBindingContext Empty { get; } = new((string?)null, null);
}
