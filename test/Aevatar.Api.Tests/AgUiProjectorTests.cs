...
public class AgUiProjectorTests
{
    ...
    public void ChatResponseEvent_ProjectsTo_FullTextMessageSequence()
    {
        ...
        events[0].Should().BeOfType<Aevatar.AGUI.TextMessageStartEvent>();
        events[1].Should().BeOfType<Aevatar.AGUI.TextMessageContentEvent>();
        events[2].Should().BeOfType<Aevatar.AGUI.TextMessageEndEvent>();

        var content = (Aevatar.AGUI.TextMessageContentEvent)events[1];
    ...
    {
        var envelope = Wrap(new Aevatar.AI.TextMessageContentEvent
        {
        ...
        events.Should().HaveCount(1);
        events[0].Should().BeOfType<Aevatar.AGUI.TextMessageContentEvent>();
    }
