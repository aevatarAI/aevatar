...
public sealed partial class WorkflowConsoleStaticAssetEndpointTests
{
    ...
    public async Task WorkflowStudio_AssistantAssets_ShouldShipNyxIdV4FeatureParity()
    {
        ...
        app.Should().Contain("import \"./transport.js?v=20260822-m60-tool-load-trace\"");
        ...
        html.Should().Contain("app.js?v=20260822-m60-tool-load-trace");
        html.Should().Contain("styles.css?v=20260822-m60-tool-load-trace");
        app.Should().Contain("transport.js?v=20260822-m60-tool-load-trace");
        app.Should().Contain("readiness.js?v=20260822-m60-tool-load-trace");
        transport.Should().Contain("readiness.js?v=20260822-m60-tool-load-trace");
        actorState.Should().Contain("protocol.js?v=20260822-m60-tool-load-trace");
        blocks.Should().Contain("protocol.js?v=20260822-m60-tool-load-trace");
