...
public sealed partial class WorkflowConsoleStaticAssetEndpointTests
{
    ...
    public async Task WorkflowStudio_AssistantAssets_ShouldShipNyxIdV4FeatureParity()
    {
        ...
        app.Should().Contain("import \"./transport.js?v=20260814-m54-plan-readonly\"");
        ...
        app.Should().Contain("transport.js?v=20260814-m54-plan-readonly");
        app.Should().Contain("readiness.js?v=20260814-m54-plan-readonly");
        transport.Should().Contain("readiness.js?v=20260814-m54-plan-readonly");
        actorState.Should().Contain("protocol.js?v=20260814-m54-plan-readonly");
        blocks.Should().Contain("protocol.js?v=20260814-m54-plan-readonly");
