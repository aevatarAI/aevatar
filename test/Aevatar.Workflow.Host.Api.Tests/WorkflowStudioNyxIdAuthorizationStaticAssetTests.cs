...
public sealed partial class WorkflowConsoleStaticAssetEndpointTests
{
    ...
    public async Task WorkflowStudio_AssistantAssets_ShouldShipNyxIdV4FeatureParity()
    {
        ...
        app.Should().Contain("import \"./transport.js?v=20260817-m55-operation-auth-trajectory\"");
        ...
        app.Should().Contain("transport.js?v=20260817-m55-operation-auth-trajectory");
        app.Should().Contain("readiness.js?v=20260817-m55-operation-auth-trajectory");
        transport.Should().Contain("readiness.js?v=20260817-m55-operation-auth-trajectory");
        actorState.Should().Contain("protocol.js?v=20260817-m55-operation-auth-trajectory");
        blocks.Should().Contain("protocol.js?v=20260817-m55-operation-auth-trajectory");
