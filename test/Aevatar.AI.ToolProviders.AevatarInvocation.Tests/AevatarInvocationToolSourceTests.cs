...
public sealed class AevatarInvocationToolSourceTests
{
    ...
    public async Task InvokeGAgent_ShouldResolveAgentKindAndDispatchEnvelopeThroughPort()
    {
        ...
        payload.ToolContext.Credentials.CredentialRef.Should().Be("access-token");
        payload.LlmControl.CredentialRef.Should().Be("access-token");
    ...
    public async Task InvokeTeam_WhenEntryServiceIsWorkflow_DispatchesServiceInvocationAndUsesAcceptedReceipt()
    {
        ...
        chatPayload.ToolContext.Credentials.CredentialRef.Should().Be("access-token");
        chatPayload.ToolContext.Credentials.SenderCredentialRef.Should().Be("sender-token");
        chatPayload.LlmControl.ModelOverride.Should().Be("model-1");
        chatPayload.LlmControl.NyxIdRoutePreference.Should().Be("route-1");
        chatPayload.LlmControl.SenderCredentialRef.Should().Be("sender-token");
        ...
        LLMControlContext? llmControl)
    {
        ...
        toolContext.Credentials.CredentialRef.Should().Be("access-token");
        ...
        llmControl!.CredentialRef.Should().Be("access-token");
        llmControl.SenderCredentialRef.Should().Be("sender-token");
