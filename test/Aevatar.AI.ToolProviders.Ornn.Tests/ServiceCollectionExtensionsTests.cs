...
public sealed class ServiceCollectionExtensionsTests
{
    ...
    [Fact]
    public void AddOrnnSkills_ShouldNotRegisterAnyTurnTimeExactRemoteFetcher()
    {
        var services = new ServiceCollection();
        services.AddSingleton(new NyxIdApiClient(
            new NyxIdToolOptions { BaseUrl = "https://nyx.example" },
        ...
        services.Should().NotContain(descriptor =>
            descriptor.ServiceType.Name.Contains("ExactRemoteSkillFetcher", StringComparison.Ordinal) ||
            descriptor.ImplementationType != null &&
            descriptor.ImplementationType.Name.Contains("ExactRemoteSkillFetcher", StringComparison.Ordinal));
