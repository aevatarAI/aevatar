...
public sealed class LlmRunExecutorTests
{
    ...
    public async Task StartAsync_ShouldDispatchForwardedToolCallRecordCommandsInOrder()
    {
        ...
        completed.RecordId.Should().Be("run_forwarded:completed:4");
        ...
        AssertDirectEnvelope(dispatch.Calls[3], completed.RecordId, RecordLlmRunCompleted.Descriptor.FullName);
    }
