...
public sealed class NyxIdAuthorizationCatalogRefreshPortTests
{
    ...
    [Fact]
    public async Task RefreshPersonalAsync_WhenPublishedNyxIdCatalogContractIsMissing_ShouldInvalidateCatalog()
    {
        ...
        result.FailureCode.Should().Be(NyxIdAuthorizationCatalogRefreshPort.PublishedContractMissingFailureCode);
        ...
        commands.Invalidations[0].Reason.Should().Be(NyxIdAuthorizationCatalogRefreshPort.PublishedContractMissingFailureCode);
