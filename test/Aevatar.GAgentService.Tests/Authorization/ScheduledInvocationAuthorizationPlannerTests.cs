...
public sealed class ScheduledInvocationAuthorizationPlannerTests
{
    ...
    public void FailureCodeWireValues_ShouldKeepDistinctDurableAndProjectionPendingSemantics()
    {
        ...
        ((int)ScheduledInvocationAuthorizationFailureCode.DurableAdmissionRequired).Should().Be(15);
        ((int)ScheduledInvocationAuthorizationFailureCode.DurableRequestGrantMismatch).Should().Be(16);
        ((int)ScheduledInvocationAuthorizationFailureCode.NyxIdOperationGrantRequired).Should().Be(17);
        ((int)ScheduledInvocationAuthorizationFailureCode.NyxIdOperationApprovalRequired).Should().Be(18);
        ((int)ScheduledInvocationAuthorizationFailureCode.NyxIdOperationDenied).Should().Be(19);
        ((int)ScheduledInvocationAuthorizationFailureCode.NyxIdOperationAuthorityContractUnavailable).Should().Be(20);
    }
