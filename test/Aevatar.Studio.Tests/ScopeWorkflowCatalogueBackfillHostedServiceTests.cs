...
public sealed class ScopeWorkflowCatalogueBackfillHostedServiceTests
{
    ...
    [Fact]
    public async Task StartAsync_ShouldBackfillServiceSourceFromLatestDeactivatedDeployment_WhenNoActiveDeployment()
    {
        var serviceCatalog = new ServiceCatalogReadModel
        {
            Id = "svc-key",
    ...
    [Fact]
    public async Task StartAsync_ShouldPreserveExistingActiveServiceSource_WhenDeactivatedSourceForDifferentServiceArrivesLater()
    {
    ...
    [Fact]
    public async Task StartAsync_ShouldBumpActiveServiceSourceVersion_WhenRestoringOverCrossServiceDeactivatedSource()
    {
    ...
    [Fact]
    public async Task StartAsync_ShouldSkipStaleServiceSourceDelete_WhenLatestActiveSourceIsOwnedByAnotherService()
    {
