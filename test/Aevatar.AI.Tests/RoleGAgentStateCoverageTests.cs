...
public sealed partial class RoleGAgentStateCoverageTests
{
    ...
    public void ApplyTurnAuthorityInitial_ShouldReplaceOnlyForNewActiveSession()
    {
        ...
        initial.DegradationReasons.Add([AgentProfileTurnDegradationReason.SelectedSkillBodyInvalid, AgentProfileTurnDegradationReason.ClassifierFailed, AgentProfileTurnDegradationReason.SelectedSkillBodyInvalid]);
    ...
    public void ApplyTurnAuthorityReconcile_ShouldOnlyAttenuateAndUnionReasons()
    {
        ...
        attenuated.CandidateRoute = null;
        attenuated.SelectedExactSkillRef = null;
        ...
        attenuated.DegradationReasons.Add(AgentProfileTurnDegradationReason.SelectedSkillBodyInvalid);
        ...
        next.AgentProfileTurnAuthority.CandidateRoute.Should().BeNull();
        next.AgentProfileTurnAuthority.SelectedExactSkillRef.Should().BeNull();
