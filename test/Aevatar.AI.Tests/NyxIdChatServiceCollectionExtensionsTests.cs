...
{
    [Fact]
    public void AddNyxIdChat_ShouldRegisterDefaultDisabledAgentProfileBinder()
    {
        ...
        services.Should().ContainSingle(descriptor =>
            descriptor.ServiceType == typeof(INyxIdChatAgentProfileBindingSource) &&
            descriptor.ImplementationType == typeof(DisabledNyxIdChatAgentProfileBindingSource));
    }
