...
public sealed class WorkflowAdditionalModulesCoverageTests
{
    ...
    public async Task LlmCallModule_ShouldForwardTypedRuntimeContextOverrides()
    {
        ...
        childContext.Credentials.NyxIdAccessToken.Should().BeNull();
        childContext.Credentials.NyxIdOrgToken.Should().BeNull();
        childContext.Credentials.SenderNyxIdAccessToken.Should().BeNull();
