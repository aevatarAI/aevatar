...
export function RegisterRoutes(app) {
    ...
    // ###########################################################################################################
    const argsWorkflowRunController_start = {
    ...
    app.post('/workflows/:workflowType/start', ...(fetchMiddlewares(WorkflowRunController)), ...(fetchMiddlewares(WorkflowRunController.prototype.start)), async function WorkflowRunController_start(request, response, next) {
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    const argsWorkflowRunController_stop = {
        workflowType: { "in": "path", "name": "workflowType", "required": true, "ref": "WorkflowType" },
    };
    app.post('/workflows/:workflowType/stop', ...(fetchMiddlewares(WorkflowRunController)), ...(fetchMiddlewares(WorkflowRunController.prototype.stop)), async function WorkflowRunController_stop(request, response, next) {
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    const argsWorkflowRunController_status = {
        workflowType: { "in": "path", "name": "workflowType", "required": true, "ref": "WorkflowType" },
    };
    app.get('/workflows/:workflowType/status', ...(fetchMiddlewares(WorkflowRunController)), ...(fetchMiddlewares(WorkflowRunController.prototype.status)), async function WorkflowRunController_status(request, response, next) {
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    const argsWorkflowRunController_allStatus = {};
    app.get('/workflows/status', ...(fetchMiddlewares(WorkflowRunController)), ...(fetchMiddlewares(WorkflowRunController.prototype.allStatus)), async function WorkflowRunController_allStatus(request, response, next) {
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    const argsHistoryController_listHistory = {
    ...
    app.get('/history', ...(fetchMiddlewares(HistoryController)), ...(fetchMiddlewares(HistoryController.prototype.listHistory)), async function HistoryController_listHistory(request, response, next) {
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    const argsHistoryController_getSessionDetail = {
        sessionId: { "in": "path", "name": "sessionId", "required": true, "dataType": "string" },
    };
    app.get('/history/:sessionId', ...(fetchMiddlewares(HistoryController)), ...(fetchMiddlewares(HistoryController.prototype.getSessionDetail)), async function HistoryController_getSessionDetail(request, response, next) {
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
