...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsWorkflowController_createWorkflow: Record<string, TsoaRoute.ParameterSchema> = {
                body: {"in":"body","name":"body","required":true,"ref":"CreateWorkflowRequest"},
        };
        app.post('/workflows',
            ...(fetchMiddlewares<RequestHandler>(WorkflowController)),
            ...(fetchMiddlewares<RequestHandler>(WorkflowController.prototype.createWorkflow)),

            async function WorkflowController_createWorkflow(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsWorkflowController_updateWorkflow: Record<string, TsoaRoute.ParameterSchema> = {
                workflowId: {"in":"path","name":"workflowId","required":true,"dataType":"string"},
                body: {"in":"body","name":"body","required":true,"ref":"UpdateWorkflowRequest"},
        };
        app.put('/workflows/:workflowId',
            ...(fetchMiddlewares<RequestHandler>(WorkflowController)),
            ...(fetchMiddlewares<RequestHandler>(WorkflowController.prototype.updateWorkflow)),

            async function WorkflowController_updateWorkflow(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsWorkflowController_getDeploymentStatus: Record<string, TsoaRoute.ParameterSchema> = {
                workflowId: {"in":"path","name":"workflowId","required":true,"dataType":"string"},
        };
        app.get('/workflows/:workflowId/deployment-status',
            ...(fetchMiddlewares<RequestHandler>(WorkflowController)),
            ...(fetchMiddlewares<RequestHandler>(WorkflowController.prototype.getDeploymentStatus)),

            async function WorkflowController_getDeploymentStatus(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsConnectorController_createConnector: Record<string, TsoaRoute.ParameterSchema> = {
                body: {"in":"body","name":"body","required":true,"ref":"CreateConnectorRequest"},
        };
        app.post('/connectors',
            ...(fetchMiddlewares<RequestHandler>(ConnectorController)),
            ...(fetchMiddlewares<RequestHandler>(ConnectorController.prototype.createConnector)),

            async function ConnectorController_createConnector(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsConnectorController_listConnectors: Record<string, TsoaRoute.ParameterSchema> = {
                page: {"default":1,"in":"query","name":"page","dataType":"double"},
                pageSize: {"default":20,"in":"query","name":"pageSize","dataType":"double"},
        };
        app.get('/connectors',
            ...(fetchMiddlewares<RequestHandler>(ConnectorController)),
            ...(fetchMiddlewares<RequestHandler>(ConnectorController.prototype.listConnectors)),

            async function ConnectorController_listConnectors(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsConnectorController_getConnector: Record<string, TsoaRoute.ParameterSchema> = {
                connectorId: {"in":"path","name":"connectorId","required":true,"dataType":"string"},
        };
        app.get('/connectors/:connectorId',
            ...(fetchMiddlewares<RequestHandler>(ConnectorController)),
            ...(fetchMiddlewares<RequestHandler>(ConnectorController.prototype.getConnector)),

            async function ConnectorController_getConnector(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsConnectorController_updateConnector: Record<string, TsoaRoute.ParameterSchema> = {
                connectorId: {"in":"path","name":"connectorId","required":true,"dataType":"string"},
                body: {"in":"body","name":"body","required":true,"ref":"UpdateConnectorRequest"},
        };
        app.put('/connectors/:connectorId',
            ...(fetchMiddlewares<RequestHandler>(ConnectorController)),
            ...(fetchMiddlewares<RequestHandler>(ConnectorController.prototype.updateConnector)),

            async function ConnectorController_updateConnector(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsConnectorController_deleteConnector: Record<string, TsoaRoute.ParameterSchema> = {
                connectorId: {"in":"path","name":"connectorId","required":true,"dataType":"string"},
        };
        app.delete('/connectors/:connectorId',
            ...(fetchMiddlewares<RequestHandler>(ConnectorController)),
            ...(fetchMiddlewares<RequestHandler>(ConnectorController.prototype.deleteConnector)),

            async function ConnectorController_deleteConnector(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsConnectorController_compileConnector: Record<string, TsoaRoute.ParameterSchema> = {
                connectorId: {"in":"path","name":"connectorId","required":true,"dataType":"string"},
        };
        app.get('/connectors/:connectorId/compile',
            ...(fetchMiddlewares<RequestHandler>(ConnectorController)),
            ...(fetchMiddlewares<RequestHandler>(ConnectorController.prototype.compileConnector)),

            async function ConnectorController_compileConnector(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsConnectorController_syncConnectors: Record<string, TsoaRoute.ParameterSchema> = {
                authorization: {"in":"header","name":"Authorization","dataType":"string"},
        };
        app.post('/connectors/sync',
            ...(fetchMiddlewares<RequestHandler>(ConnectorController)),
            ...(fetchMiddlewares<RequestHandler>(ConnectorController.prototype.syncConnectors)),

            async function ConnectorController_syncConnectors(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsCompileController_compile: Record<string, TsoaRoute.ParameterSchema> = {
                workflowId: {"in":"path","name":"workflowId","required":true,"dataType":"string"},
                body: {"in":"body","name":"body","dataType":"nestedObjectLiteral","nestedProperties":{"userToken":{"dataType":"string"}}},
        };
        app.post('/compile/:workflowId',
            ...(fetchMiddlewares<RequestHandler>(CompileController)),
            ...(fetchMiddlewares<RequestHandler>(CompileController.prototype.compile)),

            async function CompileController_compile(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsDeployController_deploy: Record<string, TsoaRoute.ParameterSchema> = {
                workflowId: {"in":"path","name":"workflowId","required":true,"dataType":"string"},
                authorization: {"in":"header","name":"Authorization","dataType":"string"},
                body: {"in":"body","name":"body","dataType":"nestedObjectLiteral","nestedProperties":{"userToken":{"dataType":"string"}}},
        };
        app.post('/deploy/:workflowId',
            ...(fetchMiddlewares<RequestHandler>(DeployController)),
            ...(fetchMiddlewares<RequestHandler>(DeployController.prototype.deploy)),

            async function DeployController_deploy(request: ExRequest, response: ExResponse, next: any) {
