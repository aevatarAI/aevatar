...
const zhCNMessages = {
  ...
  'teamMemberWorkflowStudio.templates.catalogUnavailable': '模板目录不可用',
  ...
  'teamMemberWorkflowStudio.templates.edgeSummary':
    '连线从 {source} 指向 {target}。',
  'teamMemberWorkflowStudio.templates.empty': '没有符合当前筛选条件的模板。',
  'teamMemberWorkflowStudio.templates.expectedIO': '预期输入与输出',
  'teamMemberWorkflowStudio.templates.expectedInput': '预期输入',
  'teamMemberWorkflowStudio.templates.expectedOutput': '预期输出',
  'teamMemberWorkflowStudio.templates.graphPreview': '工作流图预览',
  'teamMemberWorkflowStudio.templates.graphSummary':
    '{roles} 个{roleLabel}，{steps} 个{stepLabel}，{edges} {edgeLabel}',
  'teamMemberWorkflowStudio.templates.graphTextSummary': '工作流图文本摘要',
  'teamMemberWorkflowStudio.templates.humanInteraction': '人工交互',
  'teamMemberWorkflowStudio.templates.incompatibleDescription':
    '此模板与当前 Studio schema 或 primitive 目录不兼容。',
  'teamMemberWorkflowStudio.templates.launcher': '或从模板开始',
  'teamMemberWorkflowStudio.templates.launcherAria': '从工作流模板开始',
  'teamMemberWorkflowStudio.templates.loadFailed': '无法加载模板目录。',
  'teamMemberWorkflowStudio.templates.loading': '正在加载工作流模板',
  'teamMemberWorkflowStudio.templates.notFound': '未找到模板',
  'teamMemberWorkflowStudio.templates.notFoundDescription':
    '此模板不可用或已不再发布。',
  'teamMemberWorkflowStudio.templates.offline':
    '当前似乎处于离线状态。请重新连接后重试模板目录。',
  'teamMemberWorkflowStudio.templates.previewUnavailable': '模板预览不可用',
  ...
  'teamMemberWorkflowStudio.templates.rolePlural': '角色',
  'teamMemberWorkflowStudio.templates.roleSingular': '角色',
  'teamMemberWorkflowStudio.templates.roleSummary':
    '角色 {role} 为此工作流提供支持。',
  'teamMemberWorkflowStudio.templates.schema': 'Schema {version}',
  'teamMemberWorkflowStudio.templates.searchAria': '搜索工作流模板',
  'teamMemberWorkflowStudio.templates.searchPlaceholder': '搜索模板',
  'teamMemberWorkflowStudio.templates.selectPrompt': '选择模板以查看其工作流图。',
  'teamMemberWorkflowStudio.templates.stepPlural': '步骤',
  'teamMemberWorkflowStudio.templates.stepSingular': '步骤',
  'teamMemberWorkflowStudio.templates.stepSummary':
    '步骤 {step} 使用 {type}。',
  'teamMemberWorkflowStudio.templates.subtitle': '选择一个完整的工作流起点。',
  'teamMemberWorkflowStudio.templates.timeout':
    '模板目录请求超时。请在连接稳定后重试。',
  'teamMemberWorkflowStudio.templates.title': '工作流模板',
