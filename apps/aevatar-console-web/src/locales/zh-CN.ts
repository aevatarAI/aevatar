...
const zhCNMessages = {
  ...
  'menu.Services': '服务',
  'menu.Settings': '设置',
  'menu.Channel Settings': 'Channel 配置',
  ...
  'pages.settings.channels.actions.addSelector': '添加选择器',
  'pages.settings.channels.actions.delete': '删除',
  'pages.settings.channels.actions.refresh': '刷新',
  'pages.settings.channels.actions.remove': '移除',
  'pages.settings.channels.actions.repairDelivery': '修复投递',
  'pages.settings.channels.actions.saveRuntimeConfig': '保存运行配置',
  'pages.settings.channels.actions.testReply': '测试回复',
  'pages.settings.channels.authorization.explicitServiceAllowlist': '显式服务白名单',
  'pages.settings.channels.authorization.nyxidDefault': 'NyxID 默认',
  'pages.settings.channels.confirm.deleteRegistration': '删除注册？',
  'pages.settings.channels.content': '管理 Channel 注册运行配置。',
  'pages.settings.channels.empty.noDefaultSkill': '未设置默认 skill',
  'pages.settings.channels.empty.noRegistrations': '暂无 Channel 注册',
  'pages.settings.channels.empty.selectRegistration': '请选择一个 Channel 注册',
  'pages.settings.channels.errors.loadFailed': '无法加载 Channel 配置',
  'pages.settings.channels.errors.noSelectedRegistration': '未选择注册。',
  'pages.settings.channels.errors.runtimeConfigNotSaved': '运行配置未保存',
  'pages.settings.channels.fields.agentKeyId': 'Agent key ID',
  'pages.settings.channels.fields.authorizationMode': '授权模式',
  'pages.settings.channels.fields.authorizedServices': '已授权服务',
  'pages.settings.channels.fields.defaultSkillName': '默认 skill 名称',
  'pages.settings.channels.fields.defaultSkillVersion': '默认 skill 版本',
  'pages.settings.channels.fields.extraToolNames': '额外 tool 名称',
  'pages.settings.channels.fields.instructions': '指令',
  'pages.settings.channels.fields.nyxidServiceSelectors': 'NyxID 服务选择器',
  'pages.settings.channels.fields.platform': '平台',
  'pages.settings.channels.fields.registration': '注册',
  'pages.settings.channels.fields.scope': 'Scope',
  'pages.settings.channels.fields.toolSetRefs': 'Tool set 引用',
  'pages.settings.channels.metrics.agentKey': 'Agent key',
  'pages.settings.channels.metrics.stateVersion': '状态版本',
  'pages.settings.channels.metrics.workflowDelivery': 'Workflow 投递',
  'pages.settings.channels.placeholders.endpointNames': 'Endpoint 名称',
  'pages.settings.channels.placeholders.service': '服务',
  'pages.settings.channels.placeholders.verifiedServices': '选择已验证的 NyxID 服务',
  'pages.settings.channels.sections.registrations': '注册',
  'pages.settings.channels.status.notAvailable': '不可用',
  'pages.settings.channels.status.unknown': '未知',
  'pages.settings.channels.summary.extraTools': '额外 tools',
  'pages.settings.channels.summary.instructions': '指令',
  'pages.settings.channels.summary.runtimeDefaults': '运行默认值',
  'pages.settings.channels.summary.toolSets': 'tool sets',
  'pages.settings.channels.title': 'Channel 配置',
  ...
  'pages.chat.index.composerWorkflowInput': '发送输入以继续 workflow...',
  'pages.chat.index.composerWorkflowSignal': '发送你的 workflow 选择...',
  ...
  'pages.chat.index.workflowInputAcceptedWaiting': 'Workflow 输入已接受，workflow 正在等待下一次输入。',
  'pages.chat.index.workflowInputCompleted': 'Workflow 输入已接受，workflow 已完成。',
  'pages.chat.index.workflowSelectionResult': '已选择 {selection}。',
  'pages.chat.index.noChatHistory': '暂无会话历史',
  'pages.chat.index.noScope': '当前账号没有解析出可用 scope，请刷新后重试。',
  'pages.chat.index.openTeam': '打开 Team',
  'pages.chat.index.runInterventionAccepted': 'Run 输入已接受',
