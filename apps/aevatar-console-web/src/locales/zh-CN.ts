...
const zhCNMessages = {
  ...
  'menu.Topology': '拓扑',
  'menu.Run Console': '运行控制台',
  'menu.Workflow Library': '工作流库',
  'nav.groups.build': '构建',
  'nav.groups.operate': '运维',
  'nav.groups.release': '发布',
  'nav.groups.run': '运行',
  'nav.groups.settings': '设置',
  'nav.groups.teams': '团队',
  'nav.items.builder': '构建器',
  'nav.items.connectors': '连接器',
  'nav.items.deployments': '部署',
  'nav.items.governance': '治理',
  'nav.items.myTeams': '我的团队',
  'nav.items.runConsole': '运行控制台',
  ...
  'teams.members.actions.build': '构建 / 绑定',
  'teams.members.actions.buildFor': '构建 / 绑定 {name}',
  'teams.members.actions.clearEntry': '清除入口',
  'teams.members.actions.clearEntryFor': '清除 {name} 的入口',
  'teams.members.actions.createFirst': '创建第一个成员',
  'teams.members.actions.editInStudio': '编辑',
  'teams.members.actions.editInStudioFor': '编辑 {name}',
  'teams.members.actions.retryRoster': '重试读取成员',
  'teams.members.actions.setEntry': '设为入口',
  'teams.members.actions.setEntryFor': '将 {name} 设为入口',
  'teams.members.columns.actions': '操作',
  'teams.members.columns.implementation': '就绪状态',
  'teams.members.columns.member': '成员',
  'teams.members.columns.role': '用途',
  'teams.members.columns.service': '已发布服务',
  'teams.members.count': '{count} 个成员',
  'teams.members.description':
    '选择团队测试的入口成员。没有已发布服务的成员需要先构建并绑定。',
  ...
  'teams.members.fallback.purpose': '未填写用途',
  'teams.members.fallback.team': '未填写用途',
  'teams.members.kind': '类型：{kind}',
  ...
  'teams.members.row.label': '{name}，成员 {memberId}',
  'teams.members.service.buildFirst': '先构建并绑定',
  'teams.members.service.notPublished': '未发布服务',
  'teams.members.service.runnable': '可运行',
