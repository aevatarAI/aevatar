...
const zhCNMessages = {
  ...
  'teams.home.alerts.teamsUnavailable': '当前工作区的 Team roster 暂时不可见。',
  ...
  'teams.home.attentionDetail.teamArchived':
    '这个 Team 已归档，列表中仅保留它的后端 roster 事实。',
  'teams.home.attentionDetail.teamNoMembers':
    '这个 Team 已经存在后端事实，但还没有分配成员。',
  ...
  'teams.home.facts.teamMembers': 'Team 成员',
  ...
  'teams.home.summary.actionable': '待处理 Team',
  'teams.home.summary.healthy': '最近完成 Team',
  'teams.home.summary.total': 'AI Team 总数',
  'teams.home.team.identity': 'Team 标识：{teamId}',
  'teams.home.team.unnamed': '未命名 Team',
  ...
  'teams.detail.empty.description':
    '当前链接只有工作区上下文，没有具体 Team 标识。返回团队列表后选择一个团队。',
  ...
  'teams.detail.test.currentMemberContext':
    '当前页面选中的是 {member}，Team 测试仍通过入口成员发起。',
  ...
  'teams.detail.update.fromRun': '来自 run {runId}',
