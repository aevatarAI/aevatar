...
const workflowActivityVNextMessages: Record<keyof typeof enUSMessages, string> =
  {
    ...
    'workflowActivityVNext.activity.columnAction': '打开运行',
    ...
    'workflowActivityVNext.activity.emptyDescription':
      '工作流开始运行后，记录会显示在这里。',
    'workflowActivityVNext.activity.filterLoaded': '筛选已加载的运行',
    'workflowActivityVNext.activity.filterLoadedAria': '筛选已加载的运行',
    'workflowActivityVNext.activity.loadedCount': '已加载 {loaded} 条运行',
    'workflowActivityVNext.activity.loadedTotalCount':
      '共 {total} 条运行，已加载 {loaded} 条',
    'workflowActivityVNext.activity.loadMore': '加载更多',
    'workflowActivityVNext.activity.loadMoreFailed': '无法加载更多运行',
    ...
    'workflowActivityVNext.activity.refreshFromStart': '从头刷新',
    'workflowActivityVNext.activity.retryLoadMore': '重试加载更多',
