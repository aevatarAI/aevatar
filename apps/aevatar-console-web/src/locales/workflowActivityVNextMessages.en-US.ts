const workflowActivityVNextMessages = {
  ...
  'workflowActivityVNext.activity.beforePlaceholder': 'Activity before',
  'workflowActivityVNext.activity.clearWorkflowFilter': 'Show all workflows',
  'workflowActivityVNext.activity.columnDuration': 'Duration',
  'workflowActivityVNext.activity.columnInputPreview': 'Input preview',
  ...
  'workflowActivityVNext.activity.loading': 'Loading activity…',
  'workflowActivityVNext.activity.noMatch': 'No matching runs',
  'workflowActivityVNext.activity.originChat': 'Chat',
  'workflowActivityVNext.activity.originEditor': 'Editor',
  'workflowActivityVNext.activity.originFilter': 'Run source',
  'workflowActivityVNext.activity.originMember': 'Team member',
  'workflowActivityVNext.activity.originSchedule': 'Schedule',
  'workflowActivityVNext.activity.originService': 'Service',
  'workflowActivityVNext.activity.nextPage': 'Next page',
  'workflowActivityVNext.activity.page': 'Page {page}',
  'workflowActivityVNext.activity.pageOf': 'Page {page} of {total}',
  'workflowActivityVNext.activity.pageUnavailable': "Couldn't load this page",
  ...
  'workflowActivityVNext.common.technicalDetails': 'Technical details',
  ...
  'workflowActivityVNext.editor.addNodeFailed': "Couldn't add node",
  ...
  'workflowActivityVNext.editor.viewRun': 'View run',
  ...
  'workflowActivityVNext.run.openNewRun': 'Open new run',
  'workflowActivityVNext.run.originalRun': 'Original run',
  'workflowActivityVNext.run.parentRun': 'Parent run',
  'workflowActivityVNext.run.parentStep': 'Parent step',
  'workflowActivityVNext.run.priorOutputs': 'Prior step outputs',
  ...
  'workflowActivityVNext.run.rootRun': 'Root run',
  'workflowActivityVNext.run.sourceRun': 'Source run',
  ...
  'workflowActivityVNext.run.definitionVersion': 'Definition version',
  'workflowActivityVNext.run.editWorkflow': 'Edit workflow',
  'workflowActivityVNext.run.reviewInput': 'Review input',
  'workflowActivityVNext.run.reviewSettings': 'Review settings',
  'workflowActivityVNext.run.recommendedNextSteps': 'Recommended: {actions}',
  ...
  'workflowActivityVNext.settings.aiDescription':
    'Choose the default service and model for new AI sessions.',
  'workflowActivityVNext.settings.authenticated': 'Signed in',
  ...
  'workflowActivityVNext.settings.emailVerification': 'Email verification',
  'workflowActivityVNext.settings.executionTarget': 'Execution target',
  ...
  'workflowActivityVNext.settings.localRuntimeLabel': 'Local runtime',
  ...
  'workflowActivityVNext.settings.profile': 'Profile',
  'workflowActivityVNext.settings.profileUnavailable':
    'Profile details are unavailable.',
  'workflowActivityVNext.settings.remoteRuntimeLabel': 'Remote runtime',
  ...
  'workflowActivityVNext.settings.runtimeUnavailable':
    'Workflow execution details unavailable',
  'workflowActivityVNext.settings.runtimeUrl': 'Runtime URL',
  ...
  'workflowActivityVNext.settings.sessionAccess': 'Session & access',
  ...
  'workflowActivityVNext.schedule.failedFires': 'Failed fires',
  ...
  'workflowActivityVNext.schedule.weekly': 'Every week',
  'workflowActivityVNext.schedule.monthly': 'Every month',
  'workflowActivityVNext.schedule.dayOfWeek': 'Day of week',
  'workflowActivityVNext.schedule.dayOfMonth': 'Day of month',
  'workflowActivityVNext.schedule.weeklySummary': 'Every {day} at {time}',
  'workflowActivityVNext.schedule.monthlySummary':
    'Every month on day {day} at {time}',
  'workflowActivityVNext.schedule.weekday.0': 'Sunday',
  'workflowActivityVNext.schedule.weekday.1': 'Monday',
  'workflowActivityVNext.schedule.weekday.2': 'Tuesday',
  'workflowActivityVNext.schedule.weekday.3': 'Wednesday',
  'workflowActivityVNext.schedule.weekday.4': 'Thursday',
  'workflowActivityVNext.schedule.weekday.5': 'Friday',
  'workflowActivityVNext.schedule.weekday.6': 'Saturday',
