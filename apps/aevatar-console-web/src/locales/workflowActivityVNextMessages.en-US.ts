const workflowActivityVNextMessages = {
  ...
  'workflowActivityVNext.activity.activityAfter': 'Activity after',
  'workflowActivityVNext.activity.activityBefore': 'Activity before',
  ...
  'workflowActivityVNext.activity.openExactRunAria': 'Open run {reference}',
  'workflowActivityVNext.activity.openRun': 'Open run',
  'workflowActivityVNext.activity.openRunAria': 'Open {name} run {reference}',
  ...
  'workflowActivityVNext.activity.elapsed': '{duration} elapsed',
  'workflowActivityVNext.activity.filteredCount':
    'Showing {visible} of {loaded} loaded runs',
  'workflowActivityVNext.activity.resultCount': 'Showing {count} loaded runs',
  'workflowActivityVNext.activity.runReference': 'Run {reference}',
