const workflowActivityVNextMessages = {
  ...
  'workflowActivityVNext.activity.columnAction': 'Open run',
  ...
  'workflowActivityVNext.activity.filterLoaded': 'Filter loaded runs',
  'workflowActivityVNext.activity.filterLoadedAria': 'Filter loaded runs',
  'workflowActivityVNext.activity.loadedCount': '{loaded} runs loaded',
  'workflowActivityVNext.activity.loadedTotalCount':
    '{loaded} of {total} runs loaded',
  'workflowActivityVNext.activity.loadMore': 'Load more',
  'workflowActivityVNext.activity.loadMoreFailed': "Couldn't load more runs",
  'workflowActivityVNext.activity.loading': 'Loading activity…',
  'workflowActivityVNext.activity.noMatch': 'No matching runs',
  'workflowActivityVNext.activity.openRunAria': 'Open {name}',
  ...
  'workflowActivityVNext.activity.refreshFromStart': 'Refresh from start',
  'workflowActivityVNext.activity.retryLoadMore': 'Retry loading more',
