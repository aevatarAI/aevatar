...
const enUSMessages = {
  ...
  'pages.ai.legacyChat.loading.ariaLabel': 'Opening AI Chat',
  'pages.ai.legacyChat.loading.description': 'Opening AI Chat',
  ...
  'pages.ai.agents.collection.notMaterialized.title': 'Catalog not ready',
  'pages.ai.agents.collection.unavailable.description':
    'This Agent Profile catalog could not be loaded.',
  'pages.ai.agents.collection.unavailable.title': 'Agent catalog unavailable',
  'pages.ai.agents.error.description':
    'The Agent Profile catalogs could not be loaded.',
  'pages.ai.agents.error.title': 'Agents unavailable',
  'pages.ai.agents.loading.description':
    'Loading owned Agent Profiles and system templates.',
  'pages.ai.agents.loading.title': 'Loading Agents',
  'pages.ai.agents.notAvailable.description':
    'The backend has not enabled the Agents contract for this workspace.',
  'pages.ai.agents.notAvailable.title': 'Agents not available',
  'pages.ai.agents.owned.empty.title': 'No agents yet',
  'pages.ai.agents.owned.title': 'My Agents',
  'pages.ai.agents.pagination.next': 'Next page',
  'pages.ai.agents.pagination.page': 'Page {page}',
  'pages.ai.agents.pagination.previous': 'Previous page',
  'pages.ai.agents.purpose.empty': 'No purpose provided',
  'pages.ai.agents.refresh': 'Refresh',
  'pages.ai.agents.retry': 'Retry',
  'pages.ai.agents.revision': 'Published revision',
  'pages.ai.agents.revision.unpublished': 'Not published',
  ...
  'pages.ai.agents.scopeMismatch.title': 'Agent catalog scope mismatch',
  'pages.ai.agents.stateVersion': 'State version {version}',
  'pages.ai.agents.status.active': 'Active',
  'pages.ai.agents.status.failed': 'Failed',
  'pages.ai.agents.status.provisioning': 'Provisioning',
  'pages.ai.agents.status.unspecified': 'Unknown',
  'pages.ai.agents.system.empty.title': 'No system templates available',
  'pages.ai.agents.system.readOnly': 'Read only',
  'pages.ai.agents.system.title': 'System Templates',
  'pages.ai.agents.title': 'Agents',
  'pages.ai.agents.updatedAt': 'Updated {updatedAt}',
  ...
  'pages.ai.activity.conversations.error.title': 'Conversations unavailable',
  'pages.ai.activity.conversations.messages': '{count} messages',
  'pages.ai.activity.conversations.source': 'Chat history',
  'pages.ai.activity.conversations.title': 'Conversations',
  'pages.ai.activity.conversations.untitled': 'Untitled conversation',
  'pages.ai.activity.loadMore': 'Load more',
  'pages.ai.activity.notAvailable.description':
    'The backend has not enabled Activity for this workspace.',
  'pages.ai.activity.notAvailable.title': 'Activity not available',
  'pages.ai.activity.refresh': 'Refresh activity',
  'pages.ai.activity.refreshError.staleDescription':
    '{message} Showing the last observed page.',
  'pages.ai.activity.retry': 'Retry',
  'pages.ai.activity.runs.description': 'Workflow runs recorded for this workspace.',
  'pages.ai.activity.runs.empty':
    'No workflow runs match the current filters.',
  'pages.ai.activity.runs.error.description': 'Run activity could not be loaded.',
  'pages.ai.activity.runs.error.title': 'Runs unavailable',
  'pages.ai.activity.runs.search': 'Search runs',
  'pages.ai.activity.runs.source': 'Workflow Observatory',
  'pages.ai.activity.runs.statusFilter': 'Filter by status',
  'pages.ai.activity.runs.title': 'Runs',
  'pages.ai.activity.runs.untitled': 'Unnamed workflow run',
  'pages.ai.activity.runs.waiting': 'Waiting: {kind}',
  'pages.ai.activity.scope': 'Scope {scopeId}',
  'pages.ai.activity.scopeMismatch.description':
    'The activity source returned a different authorized scope.',
  'pages.ai.activity.scopeMismatch.title': 'Activity scope mismatch',
  'pages.ai.activity.sourceUnavailable': 'Source unavailable',
  'pages.ai.activity.status.completed': 'Completed',
  'pages.ai.activity.status.failed': 'Failed',
  'pages.ai.activity.status.running': 'Running',
  'pages.ai.activity.status.stopped': 'Stopped',
  'pages.ai.activity.status.timedOut': 'Timed out',
  'pages.ai.activity.status.unknown': 'Unknown',
  'pages.ai.activity.title': 'Activity',
  'pages.ai.activity.value.unavailable': 'Unavailable',
  'pages.ai.chat.notAvailable.description':
    'The backend has not enabled Chat for this workspace.',
  'pages.ai.chat.notAvailable.title': 'Chat not available',
  'pages.ai.overview.agents.description':
    'Owned profiles and system templates are independent catalogs.',
  'pages.ai.overview.agents.open': 'Open Agents',
  'pages.ai.overview.agents.owned': 'My Agents',
  'pages.ai.overview.agents.source': 'Agent Profile catalog',
  'pages.ai.overview.agents.system': 'System Templates',
  'pages.ai.overview.agents.title': 'Agent readiness',
  'pages.ai.overview.agents.visible': 'Visible profiles',
  'pages.ai.overview.availability.available': 'Available',
  'pages.ai.overview.availability.notMaterialized': 'Not ready',
  'pages.ai.overview.availability.unavailable': 'Unavailable',
  'pages.ai.overview.command.description':
    'Work with the agents and models available in this scope.',
  'pages.ai.overview.command.newChat': 'New Chat',
  'pages.ai.overview.command.title': 'Start a new conversation',
  'pages.ai.overview.conversations.empty.description':
    'Start a conversation to see it here.',
  'pages.ai.overview.conversations.empty.title': 'No conversations yet',
  'pages.ai.overview.conversations.messages': '{count} messages',
  'pages.ai.overview.conversations.open': 'Open conversation {title}',
  'pages.ai.overview.conversations.service.unknown': 'Unknown service',
  'pages.ai.overview.conversations.source': 'Chat history read model',
  'pages.ai.overview.conversations.title': 'Recent conversations',
  ...
  'pages.ai.overview.conversations.untitled': 'Untitled conversation',
  'pages.ai.overview.error.description':
    'The AI workspace Overview could not be loaded.',
  'pages.ai.overview.error.title': 'Overview unavailable',
  'pages.ai.overview.loading.description':
    'Reading Agent, Conversation, and Run sources.',
  'pages.ai.overview.loading.title': 'Loading Overview',
  'pages.ai.overview.notAvailable.description':
    'The backend has not enabled the Overview contract for this workspace.',
  'pages.ai.overview.notAvailable.title': 'Overview not available',
  'pages.ai.overview.refresh': 'Refresh Overview',
  'pages.ai.overview.retry': 'Retry',
  'pages.ai.overview.runs.empty.description':
    'Workflow runs will appear here after they start.',
  'pages.ai.overview.runs.empty.title': 'No recent runs',
  'pages.ai.overview.runs.input.empty': 'No input summary',
  'pages.ai.overview.runs.origin.unknown': 'Unknown origin',
  'pages.ai.overview.runs.source': 'Workflow run observatory',
  'pages.ai.overview.runs.status.unknown': 'Unknown status',
  'pages.ai.overview.runs.title': 'Recent runs',
  'pages.ai.overview.runs.unavailable.description':
    'Recent workflow runs could not be read.',
  'pages.ai.overview.runs.unavailable.title': 'Runs unavailable',
  'pages.ai.overview.runs.workflow.unnamed': 'Unnamed workflow',
  ...
  'pages.ai.overview.scopeMismatch.title': 'Overview scope mismatch',
  'pages.ai.overview.stateVersion': 'State version {version}',
  'pages.ai.overview.title': 'Overview',
  'pages.ai.overview.updatedAt': 'Updated {updatedAt}',
  'pages.ai.overview.value.unavailable': 'Unavailable',
  'pages.ai.overview.version': 'v{version}',
  'pages.ai.models.availability.available': 'Available',
  'pages.ai.models.availability.unavailable': 'Unavailable',
  'pages.ai.models.error.description':
    'The model authorities could not be read.',
  'pages.ai.models.error.title': 'Models unavailable',
  'pages.ai.models.loading.description':
    'Reading personal preferences and the scope model catalog',
  'pages.ai.models.loading.title': 'Loading models',
  'pages.ai.models.notAvailable.description':
    'Models are not enabled for this AI workspace.',
  'pages.ai.models.notAvailable.title': 'Models not available',
  'pages.ai.models.personal.authority': 'Personal preference',
  'pages.ai.models.personal.current': 'Current selection',
  'pages.ai.models.personal.manage': 'Manage personal default',
  'pages.ai.models.personal.providerDefault': 'Provider default',
  'pages.ai.models.personal.remediation.description':
    'The saved selection needs attention before it can be used reliably.',
  'pages.ai.models.personal.systemDefault': 'System default',
  'pages.ai.models.personal.systemRoute': 'System route',
  'pages.ai.models.personal.title': 'My default model',
  'pages.ai.models.personal.unspecifiedSelection': 'Unspecified',
  'pages.ai.models.personal.unsupportedSelection': 'Unsupported selection',
  'pages.ai.models.policy.customReplace': 'Scope catalog override',
  'pages.ai.models.policy.inheritPlatform': 'Inherits platform catalog',
  'pages.ai.models.refresh': 'Refresh models',
  'pages.ai.models.remediation.chooseReplacement': 'Choose a replacement',
  'pages.ai.models.remediation.connectProvider': 'Connect provider',
  'pages.ai.models.remediation.none': 'No action needed',
  'pages.ai.models.remediation.reselect': 'Select again',
  'pages.ai.models.remediation.retryCatalog': 'Retry catalog',
  'pages.ai.models.remediation.unspecified': 'Needs attention',
  'pages.ai.models.retry': 'Retry',
  ...
  'pages.ai.models.scopeMismatch.title': 'Model catalog scope mismatch',
  ...
  'pages.ai.models.selectionStatus.legacyRepairRequired': 'Migration required',
  'pages.ai.models.selectionStatus.needsRepair': 'Needs repair',
  'pages.ai.models.selectionStatus.ready': 'Ready',
  'pages.ai.models.selectionStatus.systemDefault': 'System default',
  'pages.ai.models.selectionStatus.unspecified': 'Unspecified',
  'pages.ai.models.selectionStatus.verificationUnavailable':
    'Verification unavailable',
  'pages.ai.models.title': 'Models',
  'pages.ai.models.value.unavailable': 'Unavailable',
  'pages.ai.runDetail.back': 'Back to Activity',
  'pages.ai.runDetail.completed': 'Completed',
  'pages.ai.runDetail.duration': 'Recorded duration',
  'pages.ai.runDetail.error.description': 'The run detail could not be loaded.',
  'pages.ai.runDetail.error.title': 'Run detail unavailable',
  'pages.ai.runDetail.freshness.aligned': 'Aligned',
  'pages.ai.runDetail.freshness.executionPath': 'Execution path',
  'pages.ai.runDetail.freshness.mismatch': 'Version mismatch',
  'pages.ai.runDetail.freshness.overview': 'Overview',
  'pages.ai.runDetail.freshness.steps': 'Steps',
  'pages.ai.runDetail.freshness.timeline': 'Timeline',
  'pages.ai.runDetail.freshness.title': 'Freshness',
  'pages.ai.runDetail.freshness.unavailable': 'Unavailable',
  'pages.ai.runDetail.freshness.unknown': 'Unknown',
  ...
  'pages.ai.runDetail.identityMismatch.title': 'Run identity mismatch',
  'pages.ai.runDetail.invalid.description':
    'This run detail link does not contain a valid opaque run id.',
  'pages.ai.runDetail.invalid.title': 'Invalid run link',
  'pages.ai.runDetail.notFound.description':
    'The requested run is not visible in this authenticated scope.',
  'pages.ai.runDetail.notFound.title': 'Run not found',
  'pages.ai.runDetail.observedVersion': 'Observed version {version}',
  'pages.ai.runDetail.operations.empty': 'No operations observed.',
  'pages.ai.runDetail.operations.model': 'Model',
  'pages.ai.runDetail.operations.provider': 'Provider',
  'pages.ai.runDetail.operations.title': 'Operations',
  'pages.ai.runDetail.operations.tool': 'Tool: {tool}',
  'pages.ai.runDetail.refresh': 'Refresh run detail',
  'pages.ai.runDetail.reportVersion': 'Report {version}',
  'pages.ai.runDetail.result.empty': 'No final output was recorded.',
  'pages.ai.runDetail.result.failedStep': 'Step {stepId}',
  'pages.ai.runDetail.result.failure': 'Failure',
  'pages.ai.runDetail.result.output': 'Result',
  'pages.ai.runDetail.started': 'Started',
  'pages.ai.runDetail.steps.branch': 'Branch',
  'pages.ai.runDetail.steps.empty': 'No steps observed.',
  'pages.ai.runDetail.steps.failureTruncated':
    'The recorded failure output was truncated.',
  'pages.ai.runDetail.steps.next': 'Next step',
  'pages.ai.runDetail.steps.requested': 'Requested',
  'pages.ai.runDetail.steps.suspended': 'Suspension',
  'pages.ai.runDetail.steps.suspensionTimeout':
    '{type} · timeout {seconds}s',
  'pages.ai.runDetail.steps.title': 'Steps',
  'pages.ai.runDetail.steps.total': 'Total steps',
  'pages.ai.runDetail.timeline.empty': 'No timeline events observed.',
  'pages.ai.runDetail.timeline.title': 'Timeline',
  'pages.ai.runDetail.toolCall': 'Tool call',
  'pages.ai.runDetail.usage.completion': 'Completion tokens',
  'pages.ai.runDetail.usage.cost': 'Recorded cost value',
  'pages.ai.runDetail.usage.prompt': 'Prompt tokens',
  'pages.ai.runDetail.usage.title': 'Recorded usage',
  'pages.ai.runDetail.usage.total': 'Total tokens',
  'pages.ai.shell.auth.error.description':
    'The authenticated AI workspace context could not be loaded.',
  'pages.ai.shell.auth.error.title': 'AI workspace unavailable',
  'pages.ai.shell.auth.required.description':
    'Sign in with an account that has access to an Aevatar scope.',
  'pages.ai.shell.auth.required.title': 'Authentication required',
  'pages.ai.shell.loading.ariaLabel': 'Loading AI workspace',
  ...
  'pages.ai.shell.navigation.label': 'AI workspace navigation',
  'pages.ai.shell.navigation.models': 'Models',
  'pages.ai.shell.navigation.overview': 'Overview',
  'pages.ai.shell.retry': 'Retry',
  ...
  'pages.ai.shell.scope.empty.title': 'No AI workspace scope',
  'pages.ai.shell.scope.loading': 'Resolving scope',
  'pages.ai.shell.title': 'AI Workspace',
