...
const enUSMessages = {
  ...
  'menu.Channel Settings': 'Channel Settings',
  ...
  'pages.settings.channels.actions.addSelector': 'Add selector',
  'pages.settings.channels.actions.delete': 'Delete',
  'pages.settings.channels.actions.refresh': 'Refresh',
  'pages.settings.channels.actions.remove': 'Remove',
  'pages.settings.channels.actions.repairDelivery': 'Repair delivery',
  'pages.settings.channels.actions.saveRuntimeConfig': 'Save runtime config',
  'pages.settings.channels.actions.testReply': 'Test reply',
  'pages.settings.channels.authorization.explicitServiceAllowlist': 'Explicit service allowlist',
  'pages.settings.channels.authorization.nyxidDefault': 'NyxID default',
  'pages.settings.channels.confirm.deleteRegistration': 'Delete registration?',
  'pages.settings.channels.content': 'Manage channel registration runtime configuration.',
  'pages.settings.channels.empty.noDefaultSkill': 'No default skill',
  'pages.settings.channels.empty.noRegistrations': 'No channel registrations',
  'pages.settings.channels.empty.selectRegistration': 'Select a channel registration',
  'pages.settings.channels.errors.loadFailed': 'Could not load channel settings',
  'pages.settings.channels.errors.noSelectedRegistration': 'No selected registration.',
  'pages.settings.channels.errors.runtimeConfigNotSaved': 'Runtime config was not saved',
  'pages.settings.channels.fields.agentKeyId': 'Agent key id',
  'pages.settings.channels.fields.authorizationMode': 'Authorization mode',
  'pages.settings.channels.fields.authorizedServices': 'Authorized services',
  'pages.settings.channels.fields.defaultSkillName': 'Default skill name',
  'pages.settings.channels.fields.defaultSkillVersion': 'Default skill version',
  'pages.settings.channels.fields.extraToolNames': 'Extra tool names',
  'pages.settings.channels.fields.instructions': 'Instructions',
  'pages.settings.channels.fields.nyxidServiceSelectors': 'NyxID service selectors',
  'pages.settings.channels.fields.platform': 'Platform',
  'pages.settings.channels.fields.registration': 'Registration',
  'pages.settings.channels.fields.scope': 'Scope',
  'pages.settings.channels.fields.toolSetRefs': 'Tool set refs',
  'pages.settings.channels.metrics.agentKey': 'Agent key',
  'pages.settings.channels.metrics.stateVersion': 'State version',
  'pages.settings.channels.metrics.workflowDelivery': 'Workflow delivery',
  'pages.settings.channels.placeholders.endpointNames': 'Endpoint names',
  'pages.settings.channels.placeholders.service': 'Service',
  'pages.settings.channels.placeholders.verifiedServices': 'Select verified NyxID services',
  'pages.settings.channels.sections.registrations': 'Registrations',
  'pages.settings.channels.status.notAvailable': 'not available',
  'pages.settings.channels.status.unknown': 'unknown',
  'pages.settings.channels.summary.extraTools': 'extra tools',
  'pages.settings.channels.summary.instructions': 'instructions',
  'pages.settings.channels.summary.runtimeDefaults': 'runtime defaults',
  'pages.settings.channels.summary.toolSets': 'tool sets',
  'pages.settings.channels.title': 'Channel Settings',
  ...
  'pages.chat.index.composerWorkflowInput': 'Send input to continue the workflow...',
  'pages.chat.index.composerWorkflowSignal': 'Send your workflow choice...',
  ...
  'pages.chat.index.workflowInputAcceptedWaiting': 'Workflow input accepted. The workflow is waiting for the next input.',
  'pages.chat.index.workflowInputCompleted': 'Workflow input accepted. The workflow has completed.',
  'pages.chat.index.workflowSelectionResult': '{selection} is selected.',
  ...
  'pages.chat.index.runInterventionAccepted': 'Run input accepted',
