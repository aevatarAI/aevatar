...
const enUSMessages = {
  ...
  'menu.Run Console': 'Run Console',
  'menu.Workflow Library': 'Workflow Library',
  'nav.groups.build': 'Build',
  'nav.groups.operate': 'Operate',
  'nav.groups.release': 'Release',
  'nav.groups.run': 'Run',
  'nav.groups.settings': 'Settings',
  'nav.groups.teams': 'Teams',
  'nav.items.builder': 'Builder',
  'nav.items.connectors': 'Connectors',
  'nav.items.deployments': 'Deployments',
  'nav.items.governance': 'Governance',
  'nav.items.myTeams': 'My Teams',
  'nav.items.runConsole': 'Run Console',
  ...
  'teams.members.actions.build': 'Build / Bind',
  'teams.members.actions.buildFor': 'Build / Bind {name}',
  'teams.members.actions.clearEntry': 'Clear entry',
  'teams.members.actions.clearEntryFor': 'Clear {name} as entry',
  'teams.members.actions.createFirst': 'Create first member',
  'teams.members.actions.editInStudio': 'Edit',
  'teams.members.actions.editInStudioFor': 'Edit {name}',
  'teams.members.actions.retryRoster': 'Retry member roster',
  'teams.members.actions.setEntry': 'Set entry',
  'teams.members.actions.setEntryFor': 'Set {name} as entry',
  'teams.members.columns.actions': 'Actions',
  'teams.members.columns.implementation': 'Readiness',
  'teams.members.columns.member': 'Member',
  'teams.members.columns.role': 'Purpose',
  'teams.members.columns.service': 'Published service',
  'teams.members.count': '{count, plural, one {# member} other {# members}}',
  'teams.members.description':
    'Choose the entry member for team tests. Members without a published service need Build / Bind first.',
  ...
  'teams.members.fallback.purpose': 'No purpose set',
  'teams.members.fallback.team': 'No purpose set',
  'teams.members.kind': 'Kind: {kind}',
  ...
  'teams.members.row.label': '{name}, member {memberId}',
  'teams.members.service.buildFirst': 'Build / Bind first',
  'teams.members.service.notPublished': 'No published service',
  'teams.members.service.runnable': 'Runnable',
