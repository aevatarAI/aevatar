...
import { Alert, Button, Empty, Input, Select, Space, Tabs, Typography } from 'antd';
    ...
    <div data-testid="studio-member-invoke-panel" style={surfaceStyle}>
      <div style={sectionStyle}>
        ...
        >
          <div style={{ display: 'grid', gap: 4 }}>
            ...
            <Typography.Text type="secondary">
              Call the currently selected member inside Studio and keep runtime
              observation close to the build flow.
            </Typography.Text>
          </div>
          <Space wrap size={[8, 8]}>
            <Button
        ...
        <div style={summaryGridStyle}>
          ...
          <div style={{ display: 'grid', gap: 4 }}>
            ...
            <div style={summaryValueStyle}>{currentBindingContext || 'Not configured'}</div>
          </div>
          <div style={{ display: 'grid', gap: 4 }}>
          ...
          <div style={{ display: 'grid', gap: 4 }}>
            <div style={summaryLabelStyle}>Latest Run</div>
            <div style={summaryValueStyle}>{invokeResult.runId || 'n/a'}</div>
          </div>
        </div>
      </div>
      ...
      <div style={bodyGridStyle}>
        ...
        <div style={sidePanelStyle}>
          <div style={sectionStyle}>
            <Typography.Text strong>Runtime Summary</Typography.Text>
            <div style={{ display: 'grid', gap: 10 }}>
              ...
              <div style={metricRowStyle}>
                ...
                <div style={{ display: 'grid', gap: 2 }}>
                  ...
                  <div style={summaryValueStyle}>{String(observedEvents.length)}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={sectionStyle}>
            <Typography.Text strong>Current Endpoint</Typography.Text>
            {selectedEndpoint ? (
              <div style={{ display: 'grid', gap: 8 }}>
                <div style={summaryValueStyle}>
              ...
              <Empty
                description="Pick a service endpoint to continue."
                image={Empty.PRESENTED_IMAGE_SIMPLE}
              />
            )}
          </div>
