...
export function buildChannelBindHref(scopeId: string, botId: string): string {
  return `${buildWorkflowActivitySectionHref(scopeId, 'channels')}/bind/${encodeURIComponent(botId)}`;
}
