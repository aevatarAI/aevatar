...
using Aevatar.Demos.CaseProjection.Orchestration;
...
namespace Aevatar.Demos.CaseProjection.DependencyInjection;
...
public static class ServiceCollectionExtensions
{
        ...
        Action<CaseProjectionOptions>? configure = null)
    {
        ...
        services.TryAddSingleton<IProjectionDocumentReader<CaseProjectionReadModel, string>>(sp =>
            sp.GetRequiredService<InMemoryCaseReadModelStore>());
        services.TryAddSingleton<IProjectionDocumentWriter<CaseProjectionReadModel>>(sp =>
            sp.GetRequiredService<InMemoryCaseReadModelStore>());
