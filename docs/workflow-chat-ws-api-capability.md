...
- `src/workflow/Aevatar.Workflow.Application.Abstractions/Workflows/IWorkflowDefinitionCatalog.cs`
- `src/workflow/Aevatar.Workflow.Application/Workflows/InMemoryWorkflowDefinitionCatalog.cs`
