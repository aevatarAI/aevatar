---
title: 0022 — Two-tier Inspector architecture (canonical readmodel vs observation OTel)
status: proposed
owner: eanzhao
---

# 0022 — Two-tier Inspector architecture (canonical readmodel vs observation OTel)
...
ADR [0021](0021-otel-aevatar-semantic-conventions.md) for the OTel
...
[0021](0021-otel-aevatar-semantic-conventions.md) explicitly avoids.
...
- **Restart semantics.** Inspector restarts lose Tier 2 history; Tier 1
  ...
  what ADR [0021](0021-otel-aevatar-semantic-conventions.md) enables for
  free.
...
- ADR [0021](0021-otel-aevatar-semantic-conventions.md) — the OTel
