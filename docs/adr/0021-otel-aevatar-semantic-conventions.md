---
title: 0021 — OpenTelemetry semantic conventions for aevatar.* activities
status: proposed
owner: eanzhao
---

# 0021 — OpenTelemetry semantic conventions for aevatar.* activities
...
ADR [0022](0022-two-tier-inspector-architecture.md) which depends on these
...
[0022](0022-two-tier-inspector-architecture.md)) needs these signals. We
...
- Change sampling defaults. Production samplers continue to govern the
  ...
  [0022](0022-two-tier-inspector-architecture.md)).
...
- **The Inspector demo is a thin downstream consumer.** ADR
  [0022](0022-two-tier-inspector-architecture.md) describes the
...
- **CI guards.** A new architecture guard (introduced under ADR
  [0022](0022-two-tier-inspector-architecture.md)) ensures the Inspector
...
- ADR [0022](0022-two-tier-inspector-architecture.md) — Two-tier
