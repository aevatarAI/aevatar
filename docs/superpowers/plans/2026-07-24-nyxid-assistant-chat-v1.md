...
**Interfaces:**
- Consumes: existing `ChatRequestEvent`, `AgentToolReceipt`, `AgentToolExecutionContextPayload`, `LLMControlContextPayload`, `ChatContentPart`, and `AgentProfileExecutionBinding` contracts.
